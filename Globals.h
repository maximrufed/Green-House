...
#define RELAY_EARTH_FAN 46		// Реле вентилятора земляного аккумулятора
#define R2 47
#define R3 48
#define R4 49
#define R5 50
#define R6 51
#define RELAY_WINDOW_1 52		// Реле №1 управления окнами
#define RELAY_WINDOW_2 53		// Реле №2 управления окнами
...
#define WINDOW_MOTOR_MAX_WORK_MILLIS 1000		// Максимальное время работы мотора открывания окна
