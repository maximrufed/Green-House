...
void gh_Config::EEPROM_UpdateSettings() {
  ...
  eeprom_update_block((void*)SettingsRefs.Window, (void*)EEPROMAdresses[0], sizeof(*SettingsRefs.Window));
  
  byte *b;
  b = (byte *)SettingsRefs.Window;
  ...
  eeprom_update_block((void*)SettingsRefs.TerraAccumulator, (void*)EEPROMAdresses[1], sizeof(*SettingsRefs.TerraAccumulator));
  b = (byte *)SettingsRefs.TerraAccumulator;
  ...
  eeprom_update_block((void*)SettingsRefs.WaterTank, (void*)EEPROMAdresses[2], sizeof(*SettingsRefs.WaterTank));
  b = (byte *)SettingsRefs.WaterTank;
  ...
  eeprom_update_block((void*)SettingsRefs.WaterLine1, (void*)EEPROMAdresses[3], sizeof(*SettingsRefs.WaterLine1));
  b = (byte *)SettingsRefs.WaterLine1;
  ...
  eeprom_update_block((void*)SettingsRefs.WaterLine2, (void*)EEPROMAdresses[4], sizeof(*SettingsRefs.WaterLine2));
  b = (byte *)SettingsRefs.WaterLine2;
...
void gh_Config::EEPROM_GetSettings() {
  ...
  byte *b = (byte *)SettingsRefs.Window;
  for(int i=0; i<sizeof(*SettingsRefs.Window); i++) {
    Serial.print(b[i] + (String)" ");
  }
  Serial.println();
