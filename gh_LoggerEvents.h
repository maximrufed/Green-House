...
// Коды устройств
// -----------------------------------------------------------------------
#define DEV_BOARD               0xF0     // МикроКонтроллер
#define DEV_FAN                 0xF1     // Вентилятор
#define DEV_SIDE_WINDOW         0xF2     // Боковое окно
#define DEV_DOOR_WINDOW         0xF3     // Торцевое окно
#define DEV_BARREL              0xF4     // Бочка
#define DEV_WATERING_LINE       0xF5     // Линия полива грядки
